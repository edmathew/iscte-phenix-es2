...
public class Professor extends Pessoa
{
     ...
     * @param seccao
     ***********************************************************/
    public Professor(String nome, CalendarDate dataNascimento, String email, GrauAcademico grau, Categoria nivel,
	    int extensao, String gabinete, Seccao seccao)
    {
    ...
    {
	return "Professor [grau=" + grau + ", nivel=" + nivel + ", extensao=" + extensao + ", gabinete=" + gabinete
		+ ", seccao=" + seccao.getNome() + "]";
    }
