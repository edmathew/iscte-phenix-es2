...
//	infoState();
    ...
    ***********************************************************/
	...
	} finally
	{
	    ...
	    JOptionPane.showMessageDialog(null, "Obrigado por ter escolhido a Phoenix!\nCopyright FBA, 2011",
     ...
     * 
     ***********************************************************/
    public static Scanner inicializaFicheiro(String filename) throws UserCancelException, UserErrorException
    {
    ...
    ***********************************************************/
	...
	System.out.println("AreaCientifica  :\t" + AreaCientifica.objectos().size());
	System.out.println("CalendarDate  :\t" + CalendarDate.objectos().size());
	System.out.println("Curso               :\t" + Curso.objectos().size());
	System.out.println("Departamento :\t" + Departamento.objectos().size());
	System.out.println("Disciplina         :\t" + Disciplina.objectos().size());
	System.out.println("Inscricao          :\t" + Inscricao.objectos().size());
	System.out.println("Matricula         :\t" + Matricula.objectos().size());
	System.out.println("Oferta              :\t" + Oferta.objectos().size());
	System.out.println("Perfil                :\t" + Perfil.objectos().size());
	System.out.println("Professor         :\t" + Professor.objectos().size());
	System.out.println("Seccao              :\t" + Seccao.objectos().size());
	System.out.println("----------------------------------------");
    }
	...
	try
	{
	    ...
	    Set<Object> allInstances = (HashSet<Object>) method.invoke(theClass, objectParm);

	    System.out.println("Classe: " + classname + " (#objectos = " + allInstances.size() + ")");
	    System.out.println("-----------------------------------------------------------------------------------------------");
